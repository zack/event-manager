Rails.application.routes.draw do
  ...
  get    '/special_event/invite',            to: 'special_events#invite_guest',     as: 'special_invite_guest'
  post   '/special_event/:uuid/invite',      to: 'special_events#add_guests',       as: 'special_event_add_guests'
