...
ActiveRecord::Schema[7.0].define(version: 2023_07_04_160701) do
  ...
  create_table "special_event_guests", force: :cascade do |t|
    ...
    t.index ["special_event_id"], name: "index_special_event_guests_on_special_event_id"
  end
